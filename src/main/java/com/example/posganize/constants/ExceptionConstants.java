package com.example.posganize.constants;
...
public class ExceptionConstants {
    ...
    public static final String PAYMENT_ERROR_TYPE = "Payment";
    public static final String TRAINING_ERROR_TYPE = "Training";
    public static final String SCHEDULE_ERROR_TYPE = "Schedule";
